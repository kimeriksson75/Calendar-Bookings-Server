...
const mockToken = {
    ...
    token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2NTM3ZmRiYmUzMzJiNDU3OWFkYWUwYTYiLCJpYXQiOjE2OTgxNjgyNTF9.zkMGwYhuQ7RgfZ0DYJKSjfqdhQqvNnxH8bsCrNETfcE',
...
describe('Token validation', () => {
    ...
    it('should throw an error while invalid userId', async () => {
        Token.findOne.mockReturnValue(mockToken);
        await expect(verifyToken('invalid-userId')).rejects.toThrow('Invalid id invalid-userId');
    });
});
