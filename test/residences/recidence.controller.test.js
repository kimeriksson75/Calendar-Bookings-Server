...
describe('ResidenceController.create', () => {
    ...
    it('should return 200 response and created residence data', async () => {
        ResidenceService.create = jest.fn(() => Promise.resolve(mockResidence));
    ...
    it('should handle errors', async () => {
        const errorMessage = { status: 400, message: 'Error while creating residence' };
...
describe('ResidenceController.getAll', () => {
    ...
    it('should handle errors', async () => {
        const errorMessage = { status: 400, message: 'Error while getting residences' };
        const rejectedPromise = Promise.reject(errorMessage);
...
describe('ResidenceController.getById', () => {
    ...
    it('should handle errors', async () => {
        const errorMessage = { status: 400, message: 'Error while getting residence' };
        const rejectedPromise = Promise.reject(errorMessage);
...
describe('ResidenceController._delete', () => {
    ...
    it('should handle errors', async () => {
        const errorMessage = { status: 400, message: 'Error while deleting residence' };
        const rejectedPromise = Promise.reject(errorMessage);
