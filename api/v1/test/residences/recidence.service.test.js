...
describe('ResidenceService.create', () => {
    ...
    it('should catch errors', async () => {
        Residence.create.mockRejectedValue('Error creating residence');
        await expect(ResidenceService.create(mockResidence)).rejects.toThrow('Error creating residence');
    });
...
describe('ResidenceService.getAll', () => {
    ...
    it('should catch errors', async () => {
        Residence.find.mockRejectedValue('Error getting residences');
        await expect(ResidenceService.getAll()).rejects.toThrow('Error getting residences');
    });
...
describe('ResidenceService.getById', () => {
    ...
    it('should catch errors', async () => {
        Residence.findById.mockRejectedValue('Error getting residence');
        await expect(ResidenceService.getById(mockResidence._id)).rejects.toThrow('Error getting residence');
    });
...
describe('ResidenceService.delete', () => {
    ...
    it('should catch errors', async () => {
        Residence.findByIdAndRemove.mockRejectedValue('Error deleting residence');
        await expect(ResidenceService.delete(mockResidence.id)).rejects.toThrow('Error deleting residence');
    });
